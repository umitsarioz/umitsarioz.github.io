...
tags: [algorithms, unsupervised-learning, from-scratch, association-rule]
pin: false
published: true
math: true
...
<span style='font-size:1.5rem;font-weight:bold'>A</span>priori algorithm finds frequent itemsets by <u>**iteratively**</u> scanning through transaction data and pruning infrequent items. Once frequent itemsets are identified, association rules can be generated to predict which items (or movies, in our case) are likely to occur together.
