...
2017 yılında çıkarılan Transformer mimarisi ile birlikte, bu soruna çözüm bulunmuştur. Bu mimari temelde Attention mekanizmasına dayanmaktadır. Başka bir yazıda aşağıdaki Transformer mimarisini adım adım anlatarak, pytorch ile sıfırdan kodlayacağım.

![alt text](/assets/img/ss/2024-10-01-nlp-101/image-3.png)
_Transformer Architecture_ 

Üstteki Transformer mimarisi farklı şekillerde çeşitlendirilip BERT, T5, GPT gibi mimariler ile günümüzdeki modellerde kullanılmaktadır. 
...
4. <a href="http://colah.github.io/posts/2015-08-Understanding-LSTMs/">Understanding LSTMS</a>, Christopher Olah .
